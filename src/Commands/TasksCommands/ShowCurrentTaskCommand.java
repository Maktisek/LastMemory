...
public class ShowCurrentTaskCommand implements Command {
    ...
    public String execute() {
        if(player.getCurrentTask() != null){
            return Important.writeSpace(60)+player.getCurrentTask().toString();
        }
        Important.playSound("wrong sound");
        return Important.writeSpace(60)+Important.changeText("red", "Momentálně nemáš přijmutý žádný úkol");
    }
